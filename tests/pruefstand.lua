...
pruefe("Betaeubung wird gelernt", CCAlarmDB.bekannt[4321] == "STUN")

Welt.loc = { { spellID = 9999, locType = "SCHOOL_INTERRUPT" } }
handler(addon, "LOSS_OF_CONTROL_ADDED")
pruefe("Zauberschulsperre wird NICHT gelernt", CCAlarmDB.bekannt[9999] == nil)
...
pruefe("unbekannter Zauber landet als Kandidat", CCAlarmDB.kandidatenListe[777] == "Unbekannt")
...
pruefe("/ccalarm dazu nimmt auf", CCAlarmDB.bekannt[555] == "MANUELL")
SlashCmdList.CCALARM("weg 555")
pruefe("/ccalarm weg entfernt", CCAlarmDB.bekannt[555] == nil)
